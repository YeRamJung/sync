		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "my first odata",
									"targetURL": "#sync6exercise2107-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6exercise2107-display": {
								"semanticObject": "sync6exercise2107",
								"action": "display",
								"description": "쌥구이랑 연결하기",
								"title": "my first odata",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.exercise2107",
									"url": sap.ui.require.toUrl("sync6/exercise2107")
								}
							}
						}
					}
